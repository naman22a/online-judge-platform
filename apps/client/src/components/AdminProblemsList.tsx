...
import { type IProblem, ProblemDifficulty } from '@/api/problems/types';
...
const AdminProblemsList: React.FC = () => {
    const limit = 10;
    ...
    const problemDeleteMutation = useMutation({
        mutationKey: ['problems', 'delete'],
        mutationFn: api.problems.remove,
    });
                ...
                <TableBody>
                    {problems.map((problem, index) => (
                        <TableRow key={problem.id}>
                            ...
                            <TableCell onClick={() => handleProblemDelete(problem.id)}>
